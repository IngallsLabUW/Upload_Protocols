...
ChangeClasses <- function(df, start.column) {
  ...
  #
  # Args
  #   df: MSDial-format dataframe containing sample columns.
  #   start.column: name of column where code should start applying function.
  #
  # Returns
...
## Old functions- saved just for posterity.
